...
export class BuildMonitorComponent implements OnInit {
 ...
 this.monitor = new Monitors('','','','','','','','',false,'','') 
  ...
  saveApi()
  {
    ...
    //this.monitor.jsonBody = this.jsonBody.toLocaleString();
    //this.jsonBody = preserveWhitespacesDefault(false,true);
    //JSON.parse(this.jsonBody.toString());
    this.monitor.jsonBody = this.jsonBody.toString();
    // this.monitor.jsonBody = this.jsonBody;

    this.monitor.headers = this.headers;
    //console.log(this.monitor.headerName+'  '+ this.monitor.headerValue)
    console.log(this.monitor.jsonBody);
    console.log(typeof(this.monitor.jsonBody));
    

    console.log('monitor name=  ',this.monitor_name);
